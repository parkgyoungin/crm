# Generated by Django 2.1 on 2019-09-20 15:23
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('large_scale', models.CharField(blank=True, max_length=50, null=True)),
                ('major_partner', models.CharField(blank=True, max_length=50, null=True)),
                ('closed_net', models.CharField(blank=True, max_length=50, null=True)),
                ('defense_industry', models.CharField(blank=True, max_length=50, null=True)),
                ('smart_factory', models.CharField(blank=True, max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('contract', models.CharField(blank=True, max_length=50, null=True)),
                ('block_permis', models.CharField(blank=True, max_length=50, null=True)),
                ...
                ('equipment_class', models.CharField(blank=True, max_length=50, null=True)),
                ('ownership', models.CharField(blank=True, max_length=50, null=True)),
                ('access_permis', models.CharField(blank=True, max_length=50, null=True)),
                ('termination_date', models.DateField(blank=True, null=True)),
                ('termination_reason', models.CharField(blank=True, max_length=50, null=True)),
                ('ips_rule', models.CharField(blank=True, max_length=30, null=True)),
                ('sys_log', models.CharField(blank=True, max_length=30, null=True)),
                ('icmp', models.CharField(blank=True, max_length=30, null=True)),
                ('snmp', models.CharField(blank=True, max_length=30, null=True)),
                ('snmp_sub', models.CharField(blank=True, max_length=30, null=True)),
                ('etc', models.CharField(blank=True, max_length=255, null=True)),
            ],
        ),
        migrations.CreateModel(
